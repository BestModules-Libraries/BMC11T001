...
History：         
V1.0.0   -- initial version；2023-03-16；Arduino IDE : v1.8.16
******************************************************************/
#ifndef _BMC11T001_
#define _BMC11T001_
...
class BMC11T001
{
      public:
            ...
            uint8_t readRegister_ADVANCED(uint8_t sector,uint8_t addr,uint8_t buff[]);
            uint16_t readAllRegister_ADVANCED(uint8_t buff[]);
            void writeRegister_ADVANCED(uint8_t sector,uint8_t addr,uint8_t value);
            void writeDefaultValueRegister_ADVANCED(void);
